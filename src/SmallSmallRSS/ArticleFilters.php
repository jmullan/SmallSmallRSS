...
{
    function get($filters, $title, $content, $link, $timestamp, $author, $tags)
    {
        $matches = array();
    ...
    function matchArticle($filters, $filter_name)
    {
    ...
    function assignArticleToLabel($id, $filters, $owner_uid, $article_labels)
    {
        foreach ($filters as $f) {
            if ($f["type"] == "label") {
