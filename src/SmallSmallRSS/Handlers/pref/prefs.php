...
class Pref_Prefs extends ProtectedHandler
{
    ...
    public function index()
    {
        ...
        while ($line = \SmallSmallRSS\Database::fetch_assoc($result)) {
            ...
            if ($pref_name == 'USER_LANGUAGE') {
                ...
                echo "<input type='checkbox' name='$pref_name' $checked $disabled
        ...
        /* $checked = $_SESSION["prefs_show_advanced"] ? "checked='1'" : "";
           ...
           echo "<input onclick='toggleAdvancedPrefs()'
        ...
        echo "<tr><td colspan='4'><h3>".__('System plugins').'</h3></td></tr>';
        ...
        foreach ($tmppluginhost->get_plugins() as $name => $plugin) {
            ...
            if (!empty($about[3]) && strpos($name, 'example') === false) {
                ...
                echo "<td align='center'><input disabled='1'
    ...
    public function editPrefProfiles()
    {
        ...
        echo "<input name=\"newprofile\" data-dojo-type=\"dijit.form.ValidationTextBox\"
                required=\"1\">
        ...
        echo "<table width=\"100%\" class=\"prefFeedProfileList\"
