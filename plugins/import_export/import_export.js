function exportData() {
    try {
        ...
        dialog = new dijit.Dialog({
                            ...
                            if (rv && rv.exported != undefined) {
                                if (rv.exported > 0) {
                                    ...
                                    $("export_status_message").innerHTML =
                                        ...
                                        "Exported %d articles, please wait...".replace("%d", exported);
                                    setTimeout('dijit.byId("dataExportDlg").prepare()', 2000);
                                } else {
                                    $("export_status_message").innerHTML = ngettext(
                                        "Finished, exported %d article. You can download the data <a class='visibleLink' href='%u'>here</a>.",
            ...
            execute: function() {if (this.validate()) {}},
            href: query});
        dialog.show();
    } catch (e) {
